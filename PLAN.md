...
**Framing choice**: call this an "impact monitor," not a "forecast" in the predictive-modeling sense. True geopolitical forecasting is extremely hard to do reliably, and overpromising prediction accuracy is a fast way to lose user trust the first time reality diverges. The stronger, more honest pitch is real-time impact translation with scenario framing ("if this escalates further, here's what typically follows"), not a crystal ball.
